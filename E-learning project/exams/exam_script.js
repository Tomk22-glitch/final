        ...
        function submitExam() {
            ...
            if (!studentName) {
                // If a student's name isn't entered when the timer runs out,
                // we'll still submit to avoid a blank submission.
                // You could change this to alert or a default name if you prefer.
        ...
        // This button click event now calls the same submitExam function
        // that the timer uses, so the behavior is consistent.
